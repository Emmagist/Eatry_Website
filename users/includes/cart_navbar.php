			...
			<div class="container">
			    ...
			    <div class="collapse navbar-collapse col-md-8" id="bs-example-navbar-collapse-1">
			      	<ul class="nav navbar-nav nav-main my-nav">
						...
						<li class="active"><a href="add_cart.php"><i class="fas fa-shopping-cart" aria-hidden="true"></i> <span class="badge"><?php if(isset($_SESSION['shoppingCart'])) { echo count($_SESSION['shoppingCart']);} else { echo '0';} ?></span></a>
						</li>
						<li class="dropdown">
						<a href="#">PROFILE<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="customer_dashbord.phps">Dashboard</a></li>
